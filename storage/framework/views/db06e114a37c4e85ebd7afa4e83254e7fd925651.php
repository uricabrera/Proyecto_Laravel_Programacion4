...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Hola Mundo UCH Laravel</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">Mateo Falanti y Uriel Cabrera</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Aprendiendo a usar Laravel Universidad Champagnat editando la vista
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\Xampp\htdocs\Proyect_uch\resources\views/welcome.blade.php ENDPATH**/ ?>